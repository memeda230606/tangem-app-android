...
object WalletMockContent : MockContent {
    ...
    override val derivationTaskResponse = DerivationTaskResponse(
        entries = mapOf(
            ...
            ByteArrayKey(
                byteArrayOf(-65, -53, -62, -12, -57, -32, -38, -9, -128, -52, -83, -61, 73, 39, 41, 15, -74, -97, 38, 52, -101, 63, 74, -56, -20, 15, 57, -127, 114, -93, -17, -109),
            )
                to
                ExtendedPublicKeysMap(
                    mapOf(
                    ...
                    mapOf(
                        ...
                        DerivationPath("m/44'/111111'/1'/0/0") to ExtendedPublicKey( // Kaspa (account 2)
                            publicKey = byteArrayOf(
                                2, 34, 6, 119, -106, 5, -119, 111, -22, 8, 23, -108, -72, -56, 6,
